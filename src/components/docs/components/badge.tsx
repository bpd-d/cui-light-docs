...
export function CuiDocsComponentBadge(props: any) {
    const badgeFirst = (
        <>
    ...
    return (
        <>
            <div className="cui-padding-vertical cui-padding-remove-top">
                ...
                <p>Badge adds small indicator in top right side of the component where it belongs to.
            ...
            <div className="cui-padding-vertical">
                <h2 className="cui-h2">Styling</h2>
                <p>Component comes with variety color options. To get it, use one theme or signal class along with <span className="style-class">cui-badge</span>. See example: </p>
                {ExamplePreview({
